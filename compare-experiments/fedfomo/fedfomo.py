...
if __name__ == "__main__":
    ...
    model_config = {
        'lr': args.lr, 'momentum': args.momentum, 'name': model_name,
        'criterion': args.criterion, 'optimizer': args.optimizer,
        'ep': args.local_ep, 'bs': args.local_bs, 'finetune_ep': args.finetune_ep
    }
    system_config = {
    ...
    # federated learning
    partitioned_train_dataset, partitioned_val_dataset, test_dataset_list = prepare_dataset(seed=args.seed, dataset_name=args.dataset_name, num_client=args.num_clients, 
                                                            alpha=args.alpha, target_dist_list=target_dist_list)
    message = "\n[WELCOME] Unfolding configurations...!"
    print(message); logging.info(message)

    central_server = Server(writer, partitioned_train_dataset, partitioned_val_dataset, test_dataset_list,
                            fed_config, data_config, model_config, system_config)
